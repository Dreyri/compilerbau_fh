 ...
 *  (3) the same file as (2) but with commentaries as to what each set of bytes represents. The readable file (2) can be placed into a 
...
public class JavaClassFileGenerator {
	...
	private class Method {
		...
		private void scanByteCode() {
			...
			for (int i=0; i<byteCode.length(); i+=2) {
				String temp = byteCode.substring(i, i+2);
